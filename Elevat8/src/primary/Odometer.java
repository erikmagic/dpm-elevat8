...
public class Odometer implements TimerListener {
	...
	// constructor
	public Odometer (RegulatedMotor leftMotor, RegulatedMotor rightMotor,double trackSize, double wheelRadius,int INTERVAL, boolean autostart) {
	...
	// accessors to motors
	public RegulatedMotor [] getMotors() {
		return new RegulatedMotor[] {this.leftMotor, this.rightMotor};
	}
